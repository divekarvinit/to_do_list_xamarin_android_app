...
namespace ToDoList
{
    [Activity(Label = "My ToDo List", WindowSoftInputMode = SoftInput.AdjustPan | SoftInput.StateHidden)]
    public class CreateList : ListActivity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            SetContentView (Resource.Layout.CreateList);
